						...
						<div class="tt-search tt-dropdown-obj">
							...
							<div class="tt-dropdown-menu">
								<div class="container">
									<form>
										<div class="tt-col">
											<input type="text" id="search" onkeyup="search_data()" class="tt-search-input" 	placeholder="Search Products...">
			...
			<div class="row">
				<div class="col-md-4 col-lg-3 col-xl-3 leftColumn aside" id="js-leftColumn-aside">
					...
					<div class="tt-collapse open ">
						...
						<div class="tt-collapse-content">
							<ul class="tt-filter-list" id="tagUl">
...
?>
								...
								<li class="active">
									<a href="#" class="categoryLink" data-category-id="<?php echo $row->category_id; ?>"><?php echo $row->category; ?></a>
								</li>
								<?php 
	}
}
...
?>
					...
					<div class="tt-collapse open">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list-row">
								<li class="active"><a href="#" class="priceInput" data-product-price="0,50">$0 — $50</a></li>
								<li><a href="#" class="priceInput"  data-product-price="50,100">$50 — $100</a></li>
								<li><a href="#" class="priceInput"  data-product-price="100,150">$100 — $150</a></li>
								<li><a href="#" class="priceInput" data-product-price="150,200">$150 —  $200</a></li>
							</ul>
						</div>
					</div>
					<div class="tt-collapse open">
				...
				<div class="col-md-12 col-lg-9 col-xl-9">
					<div class="content-indent container-fluid-custom-mobile-padding-02">
						...
						<div id="productContainer" class="tt-product-listing row productContainer">									
...
// })
		...
		$(".categoryLink").on("click", function(e) {
			...
			function fetchAndDisplayProducts() {
				$.ajax({
					type : "POST",
					url : "categoryFillter.php",
					data : {categoryId : categoryId},
					success :function (response){
						const obj = JSON.parse(response);

						$("#tagUl").append(obj.tag); // Set 'tag' value in #tagul
						$("#productContainer").html(obj.productsHtml); // Set 'productsHtml' value in #productContainer
						console.log(obj.tag);
					},
					error : function () {
		...
		$(".priceInput").on("click",function (){
          let priceInput = $(this).data("product-price");
		  
		  $.ajax({
					type : "POST",
					url : "priceFillter.php",
